...
*Valid value:*  existing entity registry in json format  *Default:* '/.storage/core.entity_registry'
...
| IOS App Id Number (version 2) | This only applies if you are using the IOS App version 2 and want to override the device's name assigned by iCloud3.<br><br>1. Enter the new suffix number (_3) to use a different device_tracker.<br>2. Enter 'iosappv1' to use the IOS App version 1 instead of version 2. |
